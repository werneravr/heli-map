...
window.loadFlightData = async function loadFlightData() {
    ...
    // Try to fetch from external JSON file (for http:// protocol)
    try {
        ...
        // Check if data has flights array
        if (data && data.flights && Array.isArray(data.flights)) {
            ...
            throw new Error('Invalid data structure - missing flights array');
        }
        ...
        // Use empty dataset for local viewing
        flightData = [];
        
        // Initialize the application with empty data
...
function initializeApp() {
    ...
    console.log('🎯 Step 2: Variables initialized, filteredData length:', filteredData.length);
    
    console.log('🎯 Step 3: About to call functions...');
    
    // Initialize map and setup event listeners
    console.log('🎯 Step 4: Calling initializeMap()...');
    initializeMap();
    
    console.log('🎯 Step 5: Calling setupEventListeners()...');
    setupEventListeners();
    ...
    console.log('🎯 Step 6: initializeApp() completed');
}
...
// View flight function - loads flight on map and shows flight info
function viewFlight(filename) {
    loadFlightOnMap(filename);
}

// Close modal function
function closeModal() {
    // This function is called but doesn't need to do anything specific
    // It's a placeholder for any modal closing logic
}
